...
/**
 * Code is taken from https://github.com/Microsoft/mobile-center-cli
 */
...
const rawSwaggerPath = process.argv[2];
const fixedSwaggerPath = process.argv[3];

fixupRawSwagger(rawSwaggerPath, fixedSwaggerPath);
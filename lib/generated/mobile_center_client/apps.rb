...
module MobileCenterClient
  ...
  class Apps
    ...
    def create_for_org_async(org_name, app, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = MobileCenterClient::Models::AppRequest.mapper()
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = MobileCenterClient::Models::AppResponse.mapper()
    ...
    def update_user_permissions_async(owner_name, app_name, user_email, permissions, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = MobileCenterClient::Models::UserAppPermissionsUpdateRequest.mapper()
    ...
    def update_async(app_name, owner_name, description = nil, display_name = nil, name = nil, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = MobileCenterClient::Models::AppPatchRequest.mapper()
      request_content = @client.serialize(request_mapper,  app, 'app')
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
